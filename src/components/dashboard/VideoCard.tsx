...
export default function VideoCard({ video, rank, onPlay }: VideoCardProps) {
  ...
  return (
    <div
      ...
      className="group cursor-pointer rounded-2xl overflow-hidden border transition-all duration-300 hover:-translate-y-0.5 flex flex-col"
      style={{
    ...
    >
      ...
      <div className="relative overflow-hidden shrink-0" style={{ height: '247px' }}>
        <img
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src = `https://via.placeholder.com/400x600/6366f1/ffffff?text=${encodeURIComponent(video.title.slice(0, 15))}`
          }}
        />
        ...
        {/* Top row: rank + platform + duration */}
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          <div className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/70 flex items-center justify-center transition-transform group-hover:scale-110 duration-200">
        ...
        {video.linkedProduct ? (
          ...
          >
            ...
            <a
              ...
              className="shrink-0 text-[9px] px-2 py-0.5 rounded-full font-semibold text-white transition-opacity hover:opacity-80"
